...
use App\Application\Http\Middleware\Cors;
use App\Application\Http\Middleware\EncryptCookies;
use App\Application\Http\Middleware\Jsonify;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewarePriority = [
        ...
        // make authorization and app access run first before the resolving route model bindings
        Authorize::class,
        SubstituteBindings::class,
    ];
}
